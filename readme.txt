...
Installation can be done either by searching for "UVembed Metadata" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
